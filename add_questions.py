...
questions = [
    ...
    ("Art", "2 propositions", "Vincent Van Gogh a peint 'La Nuit étoilée' ?", "Oui", "Oui", "Non", None, None, 1),
    ...
    ("Art", "2 propositions", "La Joconde est exposée au Louvre ?", "Oui", "Oui", "Non", None, None, 1),
    ...
    ("Art", "2 propositions", "Picasso était peintre ?", "Oui", "Oui", "Non", None, None, 1),
    ...
    ("Art", "2 propositions", "Léonard de Vinci a peint La Joconde ?", "Oui", "Oui", "Non", None, None, 1),
    ("Géographie", "2 propositions", "L'Afrique est-elle un continent ?", "Oui", "Oui", "Non", None, None, 1),
    ("Art", "2 propositions", "Salvador Dalí était un peintre surréaliste ?", "Oui", "Oui", "Non", None, None, 1),
    ...
    ("Art", "4 propositions", "Quel peintre a créé 'Les Nénuphars' ?", "Monet", "Van Gogh", "Picasso", "Monet", "Cézanne", 3),
    ...
    ("Art", "4 propositions", "Quel artiste a créé 'Le Penseur' ?", "Rodin", "Picasso", "Rodin", "Michel-Ange", "Monet", 3),
    ...
    ("Art", "4 propositions", "Quel mouvement artistique est associé à Van Gogh ?", "Impressionnisme", "Surréalisme", "Impressionnisme", "Cubisme", "Expressionnisme", 3),
    ...
    ("Art", "Sans proposition", "Qui a peint 'Guernica' ?", "Picasso", None, None, None, None, 5),
    ...
    ("Art", "Sans proposition", "Quel architecte a conçu la tour Eiffel ?", "Gustave Eiffel", None, None, None, None, 5)
]
